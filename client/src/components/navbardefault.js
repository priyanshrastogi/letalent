...
class NavBarDefault extends Component {
    ...
    render() {
        ...
        return (
            <nav className="navbar navbar-default fixed-top navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
...
export default connect(mapStateToProps, null)(NavBarDefault)